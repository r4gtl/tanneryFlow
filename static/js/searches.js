...
function searchFunctionGeneral(
  url,
  modalTitle,
  searchInputLabel,
  callerButtonId,
...
$('#searchResults').on('click', 'tr', function () {
  ...
  switch (callerButtonId) {
    ...
    case 'openSearchPrecautionaryStatement':
      var id_fk_precautionary_statement = $(this)
        .find('.precautionary_statement-id')
        .text();
    ...
    case 'openSearchRevisionButton':
      ...
      if (conferma) {
        ...
        var ricettaAttiva = $('#openSearchRevisionButton').data(
          'ricettaAttiva'
        ); // Passa l'id della ricetta attiva alla quale accodare. Dato passato nel button
    ...
    case 'openSearchColorRevisionButton':
      ...
      if (conferma) {
        // Ottiene l'id del prodotto chimico dalla riga cliccata
        var ricettaId = $(this).find('.ricetta-id').text();
        var ricettaAttiva = $('#openSearchColorRevisionButton').data(
          'ricettaAttiva'
        ); // Passa l'id della ricetta attiva alla quale accodare. Dato passato nel button
    ...
    case 'openSearchRevisionDrumButton':
      ...
      if (conferma) {
        // Ottiene l'id del prodotto chimico dalla riga cliccata
        var ricettaId = $(this).find('.ricetta-id').text();
        var ricettaAttiva = $('#openSearchRevisionDrumButton').data(
          'ricettaAttiva'
        ); // Passa l'id della ricetta attiva alla quale accodare. Dato passato nel button
    ...
    case 'openSearchWetColorRevisionButton':
      ...
      if (conferma) {
        // Ottiene l'id del prodotto chimico dalla riga cliccata
        var ricettaId = $(this).find('.ricetta-id').text();
        var ricettaAttiva = $('#openSearchWetColorRevisionButton').data(
          'ricettaAttiva'
        ); // Passa l'id della ricetta attiva alla quale accodare. Dato passato nel button
        console.log('ricettaAttiva: ' + ricettaAttiva);
        // Chiude il modal
